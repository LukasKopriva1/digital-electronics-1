...
begin
    ...
    begin
        ...
        assert ((s_B_greater_A = '1') and
        		(s_B_equals_A  = '1') and --chybne
                (s_B_less_A	   = '0'))
        report "Vstupni 2 kombinace nema odpovidajici vysledek k ocekavanym vysledkum" severity error;
        ...
        assert ((s_B_greater_A = '0') and
        		(s_B_equals_A  = '0') and 
                (s_B_less_A	   = '1'))
        report "Vstupni 3 kombinace nema odpovidajici vysledek k ocekavanym vysledkum" severity error;
